...
import (
	...
	"github.com/WinchainOS/Winchain/common/math"
...
var (
	...
	nanosecond2018Timestamp = mustParseRfc3339("2018-01-01T00:00:00+00:00").UnixNano()
)
...
func (ethash *Ethash) verifyHeader(chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
	//TODO【Winchain】================the part had been changed==================
	maximumExtraDataSize := params.GetMaximumExtraDataSize(chain.Config().IsWinchain)
	// 确保额外数据段具有合理的长度
	...
	if uncle {
	...
	} else if !chain.Config().IsWinchain {
		//TODO【Winchain】================the part had been changed==================
		...
		//TODO【Winchain】================the part had been changed==================
		if raftMode := time.Now().UnixNano() > nanosecond2018Timestamp; !raftMode {
...
func (ethash *Ethash) verifySeal(chain consensus.ChainReader, header *types.Header, fulldag bool) error {
	//TODO【Winchain】================the part had been changed==================
	isWinchain := chain != nil && chain.Config().IsWinchain
	...
	//TODO【Winchain】================the part had been changed==================
	if !isWinchain && !bytes.Equal(header.MixDigest[:], digest) {
