...
import (
	...
	istanbulCore "github.com/WinchainOS/Winchain/consensus/istanbul/core"
	"github.com/WinchainOS/Winchain/consensus/istanbul/validator"
...
func (sb *backend) Seal(chain consensus.ChainReader, block *types.Block, results chan<- *types.Block, stop <-chan struct{}) error {
	...
	//if sb.config.Period==0 && len(block.Transactions()) == 0{
