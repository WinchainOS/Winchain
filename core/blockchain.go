...
import (
	...
	"github.com/WinchainOS/Winchain/common/mclock"
	...
	"github.com/WinchainOS/Winchain/trie"
)
...
func (bc *BlockChain) insertChain(chain types.Blocks) (int, []interface{}, []*types.Log, error) {
	...
	for i, block := range chain {
		...
		case err == consensus.ErrFutureBlock:
			...
			//TODO【Winchain】================the part had been changed==================
			if block.Time().Cmp(max) > 0 && !bc.Config().IsWinchain {
...
//TODO【Winchain】================the part had been changed==================
func (bc *BlockChain) EthDB() ethdb.Database {
	return bc.db
}
