...
import (
	...
	"github.com/WinchainOS/Winchain/internal/build"
	"github.com/WinchainOS/Winchain/params"
	sv "github.com/WinchainOS/Winchain/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/WinchainOS/Winchain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/WinchainOS/Winchain/mobile")
