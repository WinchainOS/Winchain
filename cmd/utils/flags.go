...
import (
	...
	"github.com/WinchainOS/Winchain/common/fdlimit"
	...
	"github.com/WinchainOS/Winchain/ethstats"
	"github.com/WinchainOS/Winchain/les"
	"github.com/WinchainOS/Winchain/log"
	"github.com/WinchainOS/Winchain/metrics"
	"github.com/WinchainOS/Winchain/metrics/influxdb"
	"github.com/WinchainOS/Winchain/node"
	"github.com/WinchainOS/Winchain/p2p"
	"github.com/WinchainOS/Winchain/p2p/discover"
	"github.com/WinchainOS/Winchain/p2p/discv5"
	"github.com/WinchainOS/Winchain/p2p/nat"
	"github.com/WinchainOS/Winchain/p2p/netutil"
...
var (
	...
	RaftModeFlag = cli.BoolFlag{
		Name:  "raft",
		Usage: "If enabled, uses Raft instead of Winchain Chain for consensus",
	}
...
//TODO【Winchain】================the part had been changed==================
// RegisterEthService adds an Ethereum client to the stack.//注册节点
func RegisterEthService(stack *node.Node, cfg *eth.Config) <-chan *eth.Ethereum {
	...
	if cfg.SyncMode == downloader.LightSync {
		...
		err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
			fullNode, err := eth.New(ctx, cfg)//创建全节点
