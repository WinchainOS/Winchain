...
func initGenesis(ctx *cli.Context) error {
	...
	file.Seek(0, 0)
	genesis.Config.IsWinchain = getIsWinchain(file)
...
//TODO【Winchain】================the part had been changed==================
func getIsWinchain(file io.Reader) bool {
	...
	return altGenesis.Config.IsWinchain == nil || *altGenesis.Config.IsWinchain
}
