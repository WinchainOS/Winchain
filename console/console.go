...
import (
	...
	"github.com/WinchainOS/Winchain/internal/jsre"
	"github.com/WinchainOS/Winchain/internal/web3ext"
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Geth and Winchain JavaScript console!\n\n")
	fmt.Fprintf(c.printer, "                _       __ _               __            _\n")
	fmt.Fprintf(c.printer, "               | |     / /(_)____   _____ / /_   ____ _ (_)____\n")
	fmt.Fprintf(c.printer, "               | | /| / // // __ \\ / ___// __ \\ / __ `// // __ \\\n")
	fmt.Fprintf(c.printer, "               | |/ |/ // // / / // /__ / / / // /_/ // // / / /\n")
	fmt.Fprintf(c.printer, "               |__/|__//_//_/ /_/ \\___//_/ /_/ \\__,_//_//_/ /_/\n")
